...
- [797f33137d](https://github.com/algolia/api-clients-automation/commit/797f33137d) fix(csharp): restore ReadTimeout enforcement dropped in 7.37.0 ([#6949](https://github.com/algolia/api-clients-automation/pull/6949)) by [@MarioAlexandruDan](https://github.com/MarioAlexandruDan/)
...
- [2a0a6d58e9](https://github.com/algolia/api-clients-automation/commit/2a0a6d58e9) feat(csharp): Request-ID and Correlation-ID support ([#6869](https://github.com/algolia/api-clients-automation/pull/6869)) by [@MarioAlexandruDan](https://github.com/MarioAlexandruDan/)
...
- [7c344d49a8](https://github.com/algolia/api-clients-automation/commit/7c344d49a8) feat(csharp): configurable retries on chunked helpers via ChunkedHelperOptions ([#6318](https://github.com/algolia/api-clients-automation/pull/6318)) by [@eric-zaharia](https://github.com/eric-zaharia/)
...
- [40e643968](https://github.com/algolia/api-clients-automation/commit/40e643968) fix(csharp): Implement host reset ([#5886](https://github.com/algolia/api-clients-automation/pull/5886)) by [@MarioAlexandruDan](https://github.com/MarioAlexandruDan/)
...
- [7ac705685](https://github.com/algolia/api-clients-automation/commit/7ac705685) chore(csharp): improve error logging in DefaultSerializer ([#5768](https://github.com/algolia/api-clients-automation/pull/5768)) by [@Fluf22](https://github.com/Fluf22/)
...
- [6fdedfc52](https://github.com/algolia/api-clients-automation/commit/6fdedfc52) chore(csharp): test the support of multiple dotnet versions ([#5620](https://github.com/algolia/api-clients-automation/pull/5620)) by [@millotp](https://github.com/millotp/)
