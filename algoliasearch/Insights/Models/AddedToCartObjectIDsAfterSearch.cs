...
namespace Algolia.Search.Insights.Models
{
  ...
  public partial class AddedToCartObjectIDsAfterSearch : IEquatable<AddedToCartObjectIDsAfterSearch>
  {
    ...
    protected AddedToCartObjectIDsAfterSearch() { }
    /// <summary>
    /// Initializes a new instance of the <see cref="AddedToCartObjectIDsAfterSearch" /> class.
    /// </summary>
    ...
    public AddedToCartObjectIDsAfterSearch(string eventName = default(string), ConversionEvent eventType = default(ConversionEvent), AddToCartEvent eventSubtype = default(AddToCartEvent), string index = default(string), string queryID = default(string), List<string> objectIDs = default(List<string>), List<ObjectDataAfterSearch> objectData = default(List<ObjectDataAfterSearch>), string currency = default(string), string userToken = default(string), long timestamp = default(long), string authenticatedUserToken = default(string))
    {
      // to ensure "eventName" is required (not null)
      if (eventName == null)
      {
        throw new ArgumentNullException("eventName is a required property for AddedToCartObjectIDsAfterSearch and cannot be null");
      }
      ...
      if (index == null)
      {
        throw new ArgumentNullException("index is a required property for AddedToCartObjectIDsAfterSearch and cannot be null");
      }
      this.Index = index;
      // to ensure "queryID" is required (not null)
      if (queryID == null)
      {
        throw new ArgumentNullException("queryID is a required property for AddedToCartObjectIDsAfterSearch and cannot be null");
      }
      this.QueryID = queryID;
      // to ensure "objectIDs" is required (not null)
      if (objectIDs == null)
      {
        throw new ArgumentNullException("objectIDs is a required property for AddedToCartObjectIDsAfterSearch and cannot be null");
      }
      this.ObjectIDs = objectIDs;
      // to ensure "userToken" is required (not null)
      if (userToken == null)
      {
        throw new ArgumentNullException("userToken is a required property for AddedToCartObjectIDsAfterSearch and cannot be null");
      }
    ...
    {
      return this.Equals(input as AddedToCartObjectIDsAfterSearch);
    }

    /// <summary>
    /// Returns true if AddedToCartObjectIDsAfterSearch instances are equal
    /// </summary>
    /// <param name="input">Instance of AddedToCartObjectIDsAfterSearch to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AddedToCartObjectIDsAfterSearch input)
    {
      if (input == null)
      {
        return false;
