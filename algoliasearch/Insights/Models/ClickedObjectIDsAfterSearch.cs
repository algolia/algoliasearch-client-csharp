...
namespace Algolia.Search.Models.Insights
{
  ...
  public partial class ClickedObjectIDsAfterSearch
  {
    ...
    public ClickedObjectIDsAfterSearch(string eventName, ClickEvent eventType, string index, List<string> objectIDs, List<int> positions, string queryID, string userToken)
    {
      ...
      this.Index = index ?? throw new ArgumentNullException("index is a required property for ClickedObjectIDsAfterSearch and cannot be null");
      this.ObjectIDs = objectIDs ?? throw new ArgumentNullException("objectIDs is a required property for ClickedObjectIDsAfterSearch and cannot be null");
      this.Positions = positions ?? throw new ArgumentNullException("positions is a required property for ClickedObjectIDsAfterSearch and cannot be null");
      this.QueryID = queryID ?? throw new ArgumentNullException("queryID is a required property for ClickedObjectIDsAfterSearch and cannot be null");
      this.UserToken = userToken ?? throw new ArgumentNullException("userToken is a required property for ClickedObjectIDsAfterSearch and cannot be null");
    }
