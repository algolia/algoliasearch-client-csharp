...
namespace Algolia.Search.Insights.Models
{
  ...
  public partial class ViewedObjectIDs : IEquatable<ViewedObjectIDs>, IValidatableObject
  {
    ...
    public ViewedObjectIDs(string eventName = default(string), ViewEvent eventType = default(ViewEvent), string index = default(string), List<string> objectIDs = default(List<string>), string userToken = default(string), long timestamp = default(long), string authenticatedUserToken = default(string))
    {
      // to ensure "eventName" is required (not null)
      if (eventName == null)
      {
        throw new ArgumentNullException("eventName is a required property for ViewedObjectIDs and cannot be null");
      }
      ...
      if (index == null)
      {
        throw new ArgumentNullException("index is a required property for ViewedObjectIDs and cannot be null");
      }
      this.Index = index;
      // to ensure "objectIDs" is required (not null)
      if (objectIDs == null)
      {
        throw new ArgumentNullException("objectIDs is a required property for ViewedObjectIDs and cannot be null");
      }
      this.ObjectIDs = objectIDs;
      // to ensure "userToken" is required (not null)
      if (userToken == null)
      {
        throw new ArgumentNullException("userToken is a required property for ViewedObjectIDs and cannot be null");
      }
    ...
    {
      return this.Equals(input as ViewedObjectIDs);
    }

    /// <summary>
    /// Returns true if ViewedObjectIDs instances are equal
    /// </summary>
    /// <param name="input">Instance of ViewedObjectIDs to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ViewedObjectIDs input)
    {
      if (input == null)
      {
        return false;
