...
namespace Algolia.Search.Models.Insights
{
  ...
  public partial class ClickedFilters
  {
    ...
    {
      this.EventName = eventName ?? throw new ArgumentNullException("eventName is a required property for ClickedFilters and cannot be null");
      this.EventType = eventType;
      this.Index = index ?? throw new ArgumentNullException("index is a required property for ClickedFilters and cannot be null");
      this.Filters = filters ?? throw new ArgumentNullException("filters is a required property for ClickedFilters and cannot be null");
      this.UserToken = userToken ?? throw new ArgumentNullException("userToken is a required property for ClickedFilters and cannot be null");
    }
