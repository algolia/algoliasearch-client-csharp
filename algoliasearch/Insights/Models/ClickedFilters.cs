...
namespace Algolia.Search.Insights.Models
{
  ...
  public partial class ClickedFilters : IEquatable<ClickedFilters>, IValidatableObject
  {
    ...
    public ClickedFilters(string eventName = default(string), ClickEvent eventType = default(ClickEvent), string index = default(string), List<string> filters = default(List<string>), string userToken = default(string), long timestamp = default(long), string authenticatedUserToken = default(string))
    {
      // to ensure "eventName" is required (not null)
      if (eventName == null)
      {
        throw new ArgumentNullException("eventName is a required property for ClickedFilters and cannot be null");
      }
      ...
      if (index == null)
      {
        throw new ArgumentNullException("index is a required property for ClickedFilters and cannot be null");
      }
      this.Index = index;
      // to ensure "filters" is required (not null)
      if (filters == null)
      {
        throw new ArgumentNullException("filters is a required property for ClickedFilters and cannot be null");
      }
      this.Filters = filters;
      // to ensure "userToken" is required (not null)
      if (userToken == null)
      {
        throw new ArgumentNullException("userToken is a required property for ClickedFilters and cannot be null");
      }
    ...
    {
      return this.Equals(input as ClickedFilters);
    }

    /// <summary>
    /// Returns true if ClickedFilters instances are equal
    /// </summary>
    /// <param name="input">Instance of ClickedFilters to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ClickedFilters input)
    {
      if (input == null)
      {
        return false;
