...
namespace Algolia.Search.Models.Insights
{
  ...
  public partial class AddedToCartObjectIDs
  {
    ...
    public AddedToCartObjectIDs(string eventName, ConversionEvent eventType, AddToCartEvent eventSubtype, string index, List<string> objectIDs, string userToken)
    {
      ...
      this.Index = index ?? throw new ArgumentNullException("index is a required property for AddedToCartObjectIDs and cannot be null");
      this.ObjectIDs = objectIDs ?? throw new ArgumentNullException("objectIDs is a required property for AddedToCartObjectIDs and cannot be null");
      this.UserToken = userToken ?? throw new ArgumentNullException("userToken is a required property for AddedToCartObjectIDs and cannot be null");
    }
