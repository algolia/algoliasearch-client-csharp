...
public sealed class MonitoringConfig : AlgoliaConfig
{
  ...
  public MonitoringConfig(string appId, string apiKey)
    : base(appId, apiKey, "Monitoring", "7.28.0")
  {
