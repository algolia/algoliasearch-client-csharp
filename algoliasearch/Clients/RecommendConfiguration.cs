...
public sealed class RecommendConfig : AlgoliaConfig
{
  ...
  public RecommendConfig(string appId, string apiKey)
    : base(appId, apiKey, "Recommend", "7.38.0")
  {
