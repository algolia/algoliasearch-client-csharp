...
public sealed class AbtestingConfig : AlgoliaConfig
{
  ...
  public AbtestingConfig(string appId, string apiKey, string region = null)
    : base(appId, apiKey, "Abtesting", "7.36.2")
  {
