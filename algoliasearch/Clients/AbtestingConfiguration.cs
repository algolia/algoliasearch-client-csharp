...
public sealed class AbtestingConfig : AlgoliaConfig
{
  ...
  public AbtestingConfig(string appId, string apiKey, string region = null) : base(appId, apiKey, "Abtesting", "7.2.4")
  {
