...
public sealed class AnalyticsConfig : AlgoliaConfig
{
  ...
  public AnalyticsConfig(string appId, string apiKey, string region = null)
    : base(appId, apiKey, "Analytics", "7.34.0")
  {
