...
public partial class UsageClient : IUsageClient
{
  ...
  /// <summary>
  /// Create a new Usage client for the given appID and apiKey.
  /// </summary>
  /// <param name="applicationId">Your application</param>
  /// <param name="apiKey">Your API key</param>
  /// <param name="loggerFactory">Logger factory</param>

  public UsageClient(string applicationId, string apiKey, ILoggerFactory loggerFactory = null) : this(new UsageConfig(applicationId, apiKey), new AlgoliaHttpRequester(loggerFactory), loggerFactory)
  {
  }
  ...
  /// <param name="loggerFactory">Logger factory</param>
  public UsageClient(UsageConfig config, ILoggerFactory loggerFactory = null) : this(config, new AlgoliaHttpRequester(loggerFactory), loggerFactory)
  {
  }
  ...
  /// <param name="loggerFactory">Logger factory</param>
  public UsageClient(UsageConfig config, IHttpRequester httpRequester, ILoggerFactory loggerFactory = null)
  {
    ...
    _logger = factory.CreateLogger<UsageClient>();
  ...
  public async Task<IndexUsage> GetIndexUsageAsync(Statistic statistic, string indexName, string startDate, string endDate, Granularity? granularity = default, RequestOptions options = null, CancellationToken cancellationToken = default)
  {
    ...
    if (indexName == null)
      throw new ArgumentException("Parameter `indexName` is required when calling `GetIndexUsage`.");


    if (startDate == null)
      throw new ArgumentException("Parameter `startDate` is required when calling `GetIndexUsage`.");


    if (endDate == null)
      throw new ArgumentException("Parameter `endDate` is required when calling `GetIndexUsage`.");

    var requestOptions = new InternalRequestOptions(options);

    requestOptions.PathParameters.Add("statistic", QueryStringHelper.ParameterToString(statistic));
  ...
  public async Task<IndexUsage> GetUsageAsync(Statistic statistic, string startDate, string endDate, Granularity? granularity = default, RequestOptions options = null, CancellationToken cancellationToken = default)
  {
    ...
    if (startDate == null)
      throw new ArgumentException("Parameter `startDate` is required when calling `GetUsage`.");


    if (endDate == null)
      throw new ArgumentException("Parameter `endDate` is required when calling `GetUsage`.");
