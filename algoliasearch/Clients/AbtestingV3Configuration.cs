...
public sealed class AbtestingV3Config : AlgoliaConfig
{
  ...
  public AbtestingV3Config(string appId, string apiKey, string region = null)
    : base(appId, apiKey, "AbtestingV3", "7.37.2")
  {
