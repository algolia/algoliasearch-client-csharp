...
public sealed class SearchConfig : AlgoliaConfig
{
  ...
  public SearchConfig(string appId, string apiKey)
    : base(appId, apiKey, "Search", "7.46.1")
  {
