...
namespace Algolia.Search.Ingestion.Models
{
  ...
  public partial class RunResponse : IEquatable<RunResponse>, IValidatableObject
  {
    /// <summary>
    ...
    public RunResponse(string runID = default(string), string createdAt = default(string))
    {
      // to ensure "runID" is required (not null)
      if (runID == null)
      {
        throw new ArgumentNullException("runID is a required property for RunResponse and cannot be null");
      }
      this.RunID = runID;
      // to ensure "createdAt" is required (not null)
      if (createdAt == null)
      {
        throw new ArgumentNullException("createdAt is a required property for RunResponse and cannot be null");
      }
    ...
    {
      return this.Equals(input as RunResponse);
    }

    /// <summary>
    /// Returns true if RunResponse instances are equal
    /// </summary>
    /// <param name="input">Instance of RunResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RunResponse input)
    {
      if (input == null)
      {
        return false;
