...
namespace Algolia.Search.Ingestion.Models
{
  ...
  public partial class PlatformWithNone : AbstractOpenAPISchema, IEquatable<PlatformWithNone>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as PlatformWithNone);
    }

    /// <summary>
    /// Returns true if PlatformWithNone instances are equal
    /// </summary>
    /// <param name="input">Instance of PlatformWithNone to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(PlatformWithNone input)
    {
      if (input == null)
        return false;
