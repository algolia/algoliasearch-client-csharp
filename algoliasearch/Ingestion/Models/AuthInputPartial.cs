...
namespace Algolia.Search.Ingestion.Models
{
  ...
  public partial class AuthInputPartial : AbstractOpenAPISchema, IEquatable<AuthInputPartial>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as AuthInputPartial);
    }

    /// <summary>
    /// Returns true if AuthInputPartial instances are equal
    /// </summary>
    /// <param name="input">Instance of AuthInputPartial to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AuthInputPartial input)
    {
      if (input == null)
        return false;
