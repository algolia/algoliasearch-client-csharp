...
namespace Algolia.Search.Recommend.Models
{
  ...
  public partial class IndexSettingsAsSearchParams : IEquatable<IndexSettingsAsSearchParams>, IValidatableObject
  {
    ...
    {
      return this.Equals(input as IndexSettingsAsSearchParams);
    }

    /// <summary>
    /// Returns true if IndexSettingsAsSearchParams instances are equal
    /// </summary>
    /// <param name="input">Instance of IndexSettingsAsSearchParams to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(IndexSettingsAsSearchParams input)
    {
      if (input == null)
      {
        return false;
