...
namespace Algolia.Search.Recommend.Models
{
  ...
  public partial class BaseSearchParams : IEquatable<BaseSearchParams>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as BaseSearchParams);
    }

    /// <summary>
    /// Returns true if BaseSearchParams instances are equal
    /// </summary>
    /// <param name="input">Instance of BaseSearchParams to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(BaseSearchParams input)
    {
      if (input == null)
      {
        return false;
