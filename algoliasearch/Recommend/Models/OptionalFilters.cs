...
namespace Algolia.Search.Recommend.Models
{
  ...
  public partial class OptionalFilters : AbstractOpenAPISchema, IEquatable<OptionalFilters>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return JsonConvert.SerializeObject(this.ActualInstance, OptionalFilters.SerializerSettings);
    }
    ...
    public static OptionalFilters FromJson(string jsonString)
    {
      ...
      try
      {
        ...
        {
          newOptionalFilters = new OptionalFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, OptionalFilters.SerializerSettings));
        }
        else
        {
          newOptionalFilters = new OptionalFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, OptionalFilters.AdditionalPropertiesSerializerSettings));
        }
      ...
      try
      {
        ...
        {
          newOptionalFilters = new OptionalFilters(JsonConvert.DeserializeObject<string>(jsonString, OptionalFilters.SerializerSettings));
        }
        else
        {
          newOptionalFilters = new OptionalFilters(JsonConvert.DeserializeObject<string>(jsonString, OptionalFilters.AdditionalPropertiesSerializerSettings));
        }
    ...
    {
      return this.Equals(input as OptionalFilters);
    }

    /// <summary>
    /// Returns true if OptionalFilters instances are equal
    /// </summary>
    /// <param name="input">Instance of OptionalFilters to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(OptionalFilters input)
    {
      if (input == null)
        return false;
  ...
  public class OptionalFiltersJsonConverter : JsonConverter
  {
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
      ...
      {
        return OptionalFilters.FromJson(JObject.Load(reader).ToString(Formatting.None));
      }
      return null;
    }
