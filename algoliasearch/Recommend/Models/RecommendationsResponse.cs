...
namespace Algolia.Search.Recommend.Models
{
  ...
  public partial class RecommendationsResponse : IEquatable<RecommendationsResponse>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as RecommendationsResponse);
    }

    /// <summary>
    /// Returns true if RecommendationsResponse instances are equal
    /// </summary>
    /// <param name="input">Instance of RecommendationsResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(RecommendationsResponse input)
    {
      if (input == null)
      {
        return false;
