...
namespace Algolia.Search.Recommend.Models
{
  ...
  public partial class TagFilters : AbstractOpenAPISchema, IEquatable<TagFilters>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return JsonConvert.SerializeObject(this.ActualInstance, TagFilters.SerializerSettings);
    }

    /// <summary>
    /// Converts the JSON string into an instance of TagFilters
    /// </summary>
    /// <param name="jsonString">JSON string</param>
    /// <returns>An instance of TagFilters</returns>
    public static TagFilters FromJson(string jsonString)
    {
      TagFilters newTagFilters = null;
      ...
      try
      {
        ...
        {
          newTagFilters = new TagFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, TagFilters.SerializerSettings));
        }
        else
        {
          newTagFilters = new TagFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, TagFilters.AdditionalPropertiesSerializerSettings));
        }
      ...
      try
      {
        ...
        {
          newTagFilters = new TagFilters(JsonConvert.DeserializeObject<string>(jsonString, TagFilters.SerializerSettings));
        }
        else
        {
          newTagFilters = new TagFilters(JsonConvert.DeserializeObject<string>(jsonString, TagFilters.AdditionalPropertiesSerializerSettings));
        }
  ...
  /// <summary>
  /// Custom JSON converter for TagFilters
  /// </summary>
  public class TagFiltersJsonConverter : JsonConverter
  {
    /// <summary>
    ...
    {
      writer.WriteRawValue((string)(typeof(TagFilters).GetMethod("ToJson").Invoke(value, null)));
    }
    ...
    public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
    {
      ...
      {
        return TagFilters.FromJson(JObject.Load(reader).ToString(Formatting.None));
      }
      return null;
    }
