...
public partial class TagFilters : AbstractSchema
{
  ...
  public static TagFilters FromJson(string jsonString)
  {
    ...
    if (jToken.Type == JTokenType.Array)
    {
      try
      {
        return new TagFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
    ...
    if (jToken.Type == JTokenType.String)
    {
      try
      {
        return new TagFilters(JsonConvert.DeserializeObject<string>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
