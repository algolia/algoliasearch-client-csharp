...
/// </summary>
public partial class RecommendSearchParams
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the RecommendSearchParams class.
  /// </summary>
  ...
  /// </summary>
  /// <value>Languages for language-specific processing steps, such as word detection and dictionary settings.  **Always specify an indexing language.** If you don't specify an indexing language, the search engine uses all [supported languages](https://www.algolia.com/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/supported-languages), or the languages you specified with the `ignorePlurals` or `removeStopWords` parameters. This can lead to unexpected search results. For more information, see [Language-specific configuration](https://www.algolia.com/doc/guides/managing-results/optimize-search-results/handling-natural-languages-nlp/in-depth/language-specific-configurations). </value>
  ...
  public override string ToString()
  {
    ...
    sb.Append("  AllowCompressionOfIntegerArray: ")
      .Append(AllowCompressionOfIntegerArray)
      .Append("\n");
    sb.Append("  NumericAttributesForFiltering: ")
  ...
  {
    if (obj is not RecommendSearchParams input)
    {
      return false;
    }
    ...
    return (
      ...
      && (
        ...
        || AttributesForFaceting != null
          ...
          && AttributesForFaceting.SequenceEqual(input.AttributesForFaceting)
      )
      && (
      ...
      && (
        PaginationLimitedTo == input.PaginationLimitedTo
        || PaginationLimitedTo.Equals(input.PaginationLimitedTo)
      )
      && (
        UnretrievableAttributes == input.UnretrievableAttributes
        || UnretrievableAttributes != null
          && input.UnretrievableAttributes != null
          && UnretrievableAttributes.SequenceEqual(input.UnretrievableAttributes)
      )
      && (
        DisableTypoToleranceOnWords == input.DisableTypoToleranceOnWords
        || DisableTypoToleranceOnWords != null
          && input.DisableTypoToleranceOnWords != null
          && DisableTypoToleranceOnWords.SequenceEqual(input.DisableTypoToleranceOnWords)
      )
      && (
        AttributesToTransliterate == input.AttributesToTransliterate
        || AttributesToTransliterate != null
          && input.AttributesToTransliterate != null
          && AttributesToTransliterate.SequenceEqual(input.AttributesToTransliterate)
      )
      && (
        CamelCaseAttributes == input.CamelCaseAttributes
        || CamelCaseAttributes != null
          && input.CamelCaseAttributes != null
          && CamelCaseAttributes.SequenceEqual(input.CamelCaseAttributes)
      )
      && (
        DecompoundedAttributes == input.DecompoundedAttributes
        || (
          DecompoundedAttributes != null
          && DecompoundedAttributes.Equals(input.DecompoundedAttributes)
        )
      )
      && (
        IndexLanguages == input.IndexLanguages
        || IndexLanguages != null
          && input.IndexLanguages != null
          && IndexLanguages.SequenceEqual(input.IndexLanguages)
      )
      && (
        DisablePrefixOnAttributes == input.DisablePrefixOnAttributes
        || DisablePrefixOnAttributes != null
          && input.DisablePrefixOnAttributes != null
          && DisablePrefixOnAttributes.SequenceEqual(input.DisablePrefixOnAttributes)
      )
      && (
        AllowCompressionOfIntegerArray == input.AllowCompressionOfIntegerArray
        || AllowCompressionOfIntegerArray.Equals(input.AllowCompressionOfIntegerArray)
      )
      && (
        NumericAttributesForFiltering == input.NumericAttributesForFiltering
        || NumericAttributesForFiltering != null
          && input.NumericAttributesForFiltering != null
          && NumericAttributesForFiltering.SequenceEqual(input.NumericAttributesForFiltering)
      )
      && (
        SeparatorsToIndex == input.SeparatorsToIndex
        || (SeparatorsToIndex != null && SeparatorsToIndex.Equals(input.SeparatorsToIndex))
      )
      && (
        SearchableAttributes == input.SearchableAttributes
        || SearchableAttributes != null
          && input.SearchableAttributes != null
          && SearchableAttributes.SequenceEqual(input.SearchableAttributes)
      )
      && (UserData == input.UserData || (UserData != null && UserData.Equals(input.UserData)))
      && (
        CustomNormalization == input.CustomNormalization
        || CustomNormalization != null
          && input.CustomNormalization != null
          && CustomNormalization.SequenceEqual(input.CustomNormalization)
      )
      && (
        AttributeForDistinct == input.AttributeForDistinct
        || (AttributeForDistinct != null && AttributeForDistinct.Equals(input.AttributeForDistinct))
      )
      && (MaxFacetHits == input.MaxFacetHits || MaxFacetHits.Equals(input.MaxFacetHits))
      && (
        KeepDiacriticsOnCharacters == input.KeepDiacriticsOnCharacters
        || (
          KeepDiacriticsOnCharacters != null
          && KeepDiacriticsOnCharacters.Equals(input.KeepDiacriticsOnCharacters)
        )
      )
      && (
        CustomRanking == input.CustomRanking
        || CustomRanking != null
          && input.CustomRanking != null
          && CustomRanking.SequenceEqual(input.CustomRanking)
      )
      && (
