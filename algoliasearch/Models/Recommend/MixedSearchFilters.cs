...
public partial class MixedSearchFilters : AbstractSchema
{
  ...
  {
    if (obj is not MixedSearchFilters input)
    {
      return false;
    }
...
/// </summary>
public class MixedSearchFiltersJsonConverter : JsonConverter<MixedSearchFilters>
{
  ...
  {
    return objectType == typeof(MixedSearchFilters);
  }
  ...
  public override MixedSearchFilters Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    if (root.ValueKind == JsonValueKind.Array)
    {
      try
      {
        return new MixedSearchFilters(jsonDocument.Deserialize<List<string>>(JsonConfig.Options));
      }
    ...
    if (root.ValueKind == JsonValueKind.String)
    {
      try
      {
        return new MixedSearchFilters(jsonDocument.Deserialize<string>(JsonConfig.Options));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
  ...
  /// <param name="value">MixedSearchFilters to be converted into a JSON string</param>
  /// <param name="options">JSON Serializer options</param>
  public override void Write(Utf8JsonWriter writer, MixedSearchFilters value, JsonSerializerOptions options)
  {
