...
public class RecommendationsHitJsonConverter : JsonConverter<RecommendationsHit>
{
  ...
  public override RecommendationsHit Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
  ...
  public override void Write(Utf8JsonWriter writer, RecommendationsHit value, JsonSerializerOptions options)
  {
