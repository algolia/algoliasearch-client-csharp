...
public partial class NumericFilters : AbstractSchema
{
  ...
  public static NumericFilters FromJson(string jsonString)
  {
    ...
    if (jToken.Type == JTokenType.Array)
    {
      try
      {
        return new NumericFilters(JsonConvert.DeserializeObject<List<MixedSearchFilters>>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
    ...
    if (jToken.Type == JTokenType.String)
    {
      try
      {
        return new NumericFilters(JsonConvert.DeserializeObject<string>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
