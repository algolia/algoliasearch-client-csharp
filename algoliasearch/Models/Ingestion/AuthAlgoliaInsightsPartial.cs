...
/// </summary>
public partial class AuthAlgoliaInsightsPartial
{
  /// <summary>
  /// Initializes a new instance of the AuthAlgoliaInsightsPartial class.
  /// </summary>
  public AuthAlgoliaInsightsPartial() { }
  ...
  {
    if (obj is not AuthAlgoliaInsightsPartial input)
    {
      return false;
    }
