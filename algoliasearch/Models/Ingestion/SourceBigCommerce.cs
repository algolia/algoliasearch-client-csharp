...
public partial class SourceBigCommerce
{
  ...
  public override bool Equals(object obj)
  {
    ...
    return
        ...
        (CustomFields == input.CustomFields || CustomFields != null && input.CustomFields != null && CustomFields.SequenceEqual(input.CustomFields)) &&
        (ProductMetafields == input.ProductMetafields || ProductMetafields != null && input.ProductMetafields != null && ProductMetafields.SequenceEqual(input.ProductMetafields)) &&
        (VariantMetafields == input.VariantMetafields || VariantMetafields != null && input.VariantMetafields != null && VariantMetafields.SequenceEqual(input.VariantMetafields));
  }
