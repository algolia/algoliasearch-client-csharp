...
public class TaskCreateTriggerJsonConverter : JsonConverter<TaskCreateTrigger>
{
  ...
  public override TaskCreateTrigger Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    if (root.ValueKind == JsonValueKind.Object)
    {
      try
      {
        return new TaskCreateTrigger(jsonDocument.Deserialize<OnDemandTriggerInput>(JsonConfig.Options));
      }
    ...
    if (root.ValueKind == JsonValueKind.Object)
    {
      try
      {
        return new TaskCreateTrigger(jsonDocument.Deserialize<SubscriptionTrigger>(JsonConfig.Options));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
  ...
  public override void Write(Utf8JsonWriter writer, TaskCreateTrigger value, JsonSerializerOptions options)
  {
