...
public partial class TopSearchWithRevenueAnalytics
{
  ...
  public TopSearchWithRevenueAnalytics(
    ...
    List<ClickPosition> clickPositions,
    double? conversionRate,
    int trackedSearchCount,
    int clickCount,
    int conversionCount,
    int nbHits,
    Dictionary<string, CurrencyCode> currencies,
  ...
  )
  {
    ...
    Count = count;
    ClickThroughRate =
      clickThroughRate ?? throw new ArgumentNullException(nameof(clickThroughRate));
    AverageClickPosition =
      averageClickPosition ?? throw new ArgumentNullException(nameof(averageClickPosition));
  ...
  public override bool Equals(object obj)
  {
    ...
    return (Search == input.Search || (Search != null && Search.Equals(input.Search)))
      ...
      && (
        ...
        || ClickPositions != null
          && input.ClickPositions != null
          && ClickPositions.SequenceEqual(input.ClickPositions)
      )
      && (
