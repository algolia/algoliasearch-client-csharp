...
/// SearchForHits
/// </summary>
public partial class SearchForHits
{
  /// <summary>
  ...
  /// <summary>
  /// Initializes a new instance of the SearchForHits class.
  /// </summary>
  [JsonConstructor]
  ...
  public SearchForHits(string indexName)
  {
  ...
  {
    if (obj is not SearchForHits input)
    {
      return false;
    }
