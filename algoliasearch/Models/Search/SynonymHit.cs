...
public partial class SynonymHit
{
  ...
  public override bool Equals(object obj)
  {
    ...
    return
        ...
        (Synonyms == input.Synonyms || Synonyms != null && input.Synonyms != null && Synonyms.SequenceEqual(input.Synonyms)) &&
        (Input == input.Input || (Input != null && Input.Equals(input.Input))) &&
        (Word == input.Word || (Word != null && Word.Equals(input.Word))) &&
        (Corrections == input.Corrections || Corrections != null && input.Corrections != null && Corrections.SequenceEqual(input.Corrections)) &&
        (Placeholder == input.Placeholder || (Placeholder != null && Placeholder.Equals(input.Placeholder))) &&
        (Replacements == input.Replacements || Replacements != null && input.Replacements != null && Replacements.SequenceEqual(input.Replacements));
  }
