...
/// </summary>
public partial class SearchResponsePartial<T>
{
  /// <summary>
  /// Initializes a new instance of the SearchResponsePartial class.
  /// </summary>
  ...
  {
    if (obj is not SearchResponsePartial<T> input)
    {
      return false;
    }
    ...
    return (AbTestID == input.AbTestID || AbTestID.Equals(input.AbTestID))
      ...
      && (
        AutomaticRadius == input.AutomaticRadius
        || (AutomaticRadius != null && AutomaticRadius.Equals(input.AutomaticRadius))
      )
      && (
      ...
      && (
        ExhaustiveNbHits == input.ExhaustiveNbHits
        || ExhaustiveNbHits.Equals(input.ExhaustiveNbHits)
      )
      ...
      && (
        FacetsStats == input.FacetsStats
        || FacetsStats != null
          && input.FacetsStats != null
          && FacetsStats.SequenceEqual(input.FacetsStats)
      )
      ...
      && (
        ...
        || (ParsedQuery != null && ParsedQuery.Equals(input.ParsedQuery))
      )
      && (
      ...
      && (
        ProcessingTimingsMS == input.ProcessingTimingsMS
        || (ProcessingTimingsMS != null && ProcessingTimingsMS.Equals(input.ProcessingTimingsMS))
      )
      && (
        QueryAfterRemoval == input.QueryAfterRemoval
        || (QueryAfterRemoval != null && QueryAfterRemoval.Equals(input.QueryAfterRemoval))
      )
      ...
      && (
        ServerUsed == input.ServerUsed
        || (ServerUsed != null && ServerUsed.Equals(input.ServerUsed))
      )
