...
public partial class IndexSettings
{
  ...
  /// <summary>
  /// Gets or Sets AttributeCriteriaComputedBy
  /// </summary>
  [JsonPropertyName("attributeCriteriaComputedBy")]
  public AttributeCriteriaComputedBy? AttributeCriteriaComputedBy { get; set; }
  ...
  public override string ToString()
  {
    ...
    sb.Append("  AttributeCriteriaComputedByMinProximity: ")
      ...
      .Append("\n");
    sb.Append("  AttributeCriteriaComputedBy: ").Append(AttributeCriteriaComputedBy).Append("\n");
  ...
  {
    if (obj is not IndexSettings input)
    {
      return false;
    }
    ...
    return (
      ...
      && (
        ...
        || (SemanticSearch != null && SemanticSearch.Equals(input.SemanticSearch))
      )
      ...
      && (
        AttributeCriteriaComputedBy == input.AttributeCriteriaComputedBy
        || AttributeCriteriaComputedBy.Equals(input.AttributeCriteriaComputedBy)
      )
      && (
  ...
  public override int GetHashCode()
  {
    unchecked // Overflow is fine, just wrap
    {
      ...
      hashCode = (hashCode * 59) + AttributeCriteriaComputedBy.GetHashCode();
