...
public partial class StandardEntries
{
  ...
  public override bool Equals(object obj)
  {
    ...
    return
        (Plurals == input.Plurals || Plurals != null && input.Plurals != null && Plurals.SequenceEqual(input.Plurals)) &&
        (Stopwords == input.Stopwords || Stopwords != null && input.Stopwords != null && Stopwords.SequenceEqual(input.Stopwords)) &&
        (Compounds == input.Compounds || Compounds != null && input.Compounds != null && Compounds.SequenceEqual(input.Compounds));
  }
