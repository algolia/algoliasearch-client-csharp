...
public partial class AttributeToUpdate : AbstractSchema
{
  ...
  {
    if (obj is not AttributeToUpdate input)
    {
      return false;
    }
...
/// </summary>
public class AttributeToUpdateJsonConverter : JsonConverter<AttributeToUpdate>
{
  ...
  {
    return objectType == typeof(AttributeToUpdate);
  }
  ...
  public override AttributeToUpdate Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    if (root.ValueKind == JsonValueKind.Object)
    {
      try
      {
        return new AttributeToUpdate(jsonDocument.Deserialize<BuiltInOperation>(JsonConfig.Options));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
        System.Diagnostics.Debug.WriteLine($"Failed to deserialize into BuiltInOperation: {exception}");
      }
    }
  ...
  /// <param name="value">AttributeToUpdate to be converted into a JSON string</param>
  /// <param name="options">JSON Serializer options</param>
  public override void Write(Utf8JsonWriter writer, AttributeToUpdate value, JsonSerializerOptions options)
  {
