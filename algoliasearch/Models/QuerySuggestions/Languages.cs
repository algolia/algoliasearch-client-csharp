...
public partial class Languages : AbstractSchema
{
  ...
  public static Languages FromJson(string jsonString)
  {
    ...
    if (jToken.Type == JTokenType.Array)
    {
      try
      {
        return new Languages(JsonConvert.DeserializeObject<List<string>>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
    ...
    if (jToken.Type == JTokenType.Boolean)
    {
      try
      {
        return new Languages(JsonConvert.DeserializeObject<bool>(jsonString, JsonConfig.AlgoliaJsonSerializerSettings));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
