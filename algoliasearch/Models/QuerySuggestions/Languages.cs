...
/// </summary>
public class LanguagesJsonConverter : JsonConverter<Languages>
{
  ...
  {
    return objectType == typeof(Languages);
  }
  ...
  public override Languages Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
    ...
    if (root.ValueKind == JsonValueKind.Array)
    {
      try
      {
        return new Languages(jsonDocument.Deserialize<List<string>>(JsonConfig.Options));
      }
    ...
    if (root.ValueKind == JsonValueKind.True || root.ValueKind == JsonValueKind.False)
    {
      try
      {
        return new Languages(jsonDocument.Deserialize<bool>(JsonConfig.Options));
      }
      catch (Exception exception)
      {
        // deserialization failed, try the next one
  ...
  /// <param name="value">Languages to be converted into a JSON string</param>
  /// <param name="options">JSON Serializer options</param>
  public override void Write(Utf8JsonWriter writer, Languages value, JsonSerializerOptions options)
  {
