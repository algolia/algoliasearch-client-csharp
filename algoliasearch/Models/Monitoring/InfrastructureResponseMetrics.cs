...
public partial class InfrastructureResponseMetrics
{
  ...
  public override bool Equals(object obj)
  {
    ...
    return
        (CpuUsage == input.CpuUsage || CpuUsage != null && input.CpuUsage != null && CpuUsage.SequenceEqual(input.CpuUsage)) &&
        (RamIndexingUsage == input.RamIndexingUsage || RamIndexingUsage != null && input.RamIndexingUsage != null && RamIndexingUsage.SequenceEqual(input.RamIndexingUsage)) &&
        (RamSearchUsage == input.RamSearchUsage || RamSearchUsage != null && input.RamSearchUsage != null && RamSearchUsage.SequenceEqual(input.RamSearchUsage)) &&
        (SsdUsage == input.SsdUsage || SsdUsage != null && input.SsdUsage != null && SsdUsage.SequenceEqual(input.SsdUsage)) &&
        (AvgBuildTime == input.AvgBuildTime || AvgBuildTime != null && input.AvgBuildTime != null && AvgBuildTime.SequenceEqual(input.AvgBuildTime));
  }
