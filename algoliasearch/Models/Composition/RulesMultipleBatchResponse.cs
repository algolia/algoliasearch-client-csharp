...
/// </summary>
public partial class RulesMultipleBatchResponse
{
  /// <summary>
  /// Initializes a new instance of the RulesMultipleBatchResponse class.
  /// </summary>
  [JsonConstructor]
  ...
  public RulesMultipleBatchResponse(long taskID)
  {
    TaskID = taskID;
  }
  ...
  {
    if (obj is not RulesMultipleBatchResponse input)
    {
      return false;
    }
