...
public partial class InjectedItemHitsMetadata
{
  ...
  /// </summary>
  /// <value>When true, each affected hit's `_extra` object includes an `_injectedItemKey` field identifying the injectedItem that inserted it. Defaults to false, meaning hits don't include `_injectedItemKey`. To identify injected hits without this flag, define your own key-value pairs in `extra`.</value>
