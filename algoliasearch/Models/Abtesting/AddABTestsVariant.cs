...
public class AddABTestsVariantJsonConverter : JsonConverter<AddABTestsVariant>
{
  ...
  public override AddABTestsVariant Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
  {
  ...
  public override void Write(Utf8JsonWriter writer, AddABTestsVariant value, JsonSerializerOptions options)
  {
