...
public partial class EmptySearchFilter
{
  ...
  public override bool Equals(object obj)
  {
    ...
    return (UsersCount == input.UsersCount || UsersCount.Equals(input.UsersCount))
      && (
        TrackedSearchesCount == input.TrackedSearchesCount
        || TrackedSearchesCount.Equals(input.TrackedSearchesCount)
      );
  }
