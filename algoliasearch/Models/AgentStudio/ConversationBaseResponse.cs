...
/// </summary>
public partial class ConversationBaseResponse
{
  /// <summary>
  /// Initializes a new instance of the ConversationBaseResponse class.
  /// </summary>
  [JsonConstructor]
  public ConversationBaseResponse() { }
  ...
  public ConversationBaseResponse(string id, string agentId, string createdAt, string updatedAt)
  {
  ...
  {
    if (obj is not ConversationBaseResponse input)
    {
      return false;
    }
