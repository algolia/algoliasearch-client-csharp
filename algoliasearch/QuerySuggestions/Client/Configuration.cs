...
namespace Algolia.Search.QuerySuggestions.Client
{
  ...
  public class Configuration : IReadableConfiguration
  {
    ...
    public Configuration()
    {
      ...
      BasePath = "https://query-suggestions.us.algolia.com";
            ...
            {
                {
                    new Dictionary<string, object> {
                        ...
                        {"description", "You can check the region for your application in the [Algolia dashboard](https://dashboard.algolia.com/account/infrastructure/analytics). If you connect to the wrong region, the API returns an error with the status `401` and the message: \"The log processing region does not match\". "},
                        {
    ...
    public Configuration(
        ...
        string basePath = "https://query-suggestions.us.algolia.com") : this()
    {
    ...
    {
      string report = "C# SDK (Algolia.Search.QuerySuggestions) Debug Report:\n";
