...
namespace Algolia.Search.Search.Models
{
  ...
  public partial class IndexSettings : IEquatable<IndexSettings>, IValidatableObject
  {
    ...
    {
      return this.Equals(input as IndexSettings);
    }

    /// <summary>
    /// Returns true if IndexSettings instances are equal
    /// </summary>
    /// <param name="input">Instance of IndexSettings to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(IndexSettings input)
    {
      if (input == null)
      {
        return false;
