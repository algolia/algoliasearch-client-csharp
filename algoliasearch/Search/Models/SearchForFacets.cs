...
namespace Algolia.Search.Models.Search
{
  ...
  public partial class SearchForFacets
  {
    ...
    {
      this.Facet = facet ?? throw new ArgumentNullException("facet is a required property for SearchForFacets and cannot be null");
      this.IndexName = indexName ?? throw new ArgumentNullException("indexName is a required property for SearchForFacets and cannot be null");
      this.Type = type;
    }
