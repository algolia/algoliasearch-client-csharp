...
namespace Algolia.Search.Models.Search
{
  ...
  public partial class SearchResponse<T>
  {
    ...
    public SearchResponse(int? hitsPerPage, int? nbHits, int? nbPages, int? page, int? processingTimeMS, List<T> hits, string query, string varParams)
    {
      ...
      this.Hits = hits ?? throw new ArgumentNullException("hits is a required property for SearchResponse and cannot be null");
      this.Query = query ?? throw new ArgumentNullException("query is a required property for SearchResponse and cannot be null");
      this.VarParams = varParams ?? throw new ArgumentNullException("varParams is a required property for SearchResponse and cannot be null");
      this.AdditionalProperties = new Dictionary<string, object>();
    }
