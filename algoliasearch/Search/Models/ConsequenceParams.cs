...
namespace Algolia.Search.Search.Models
{
  ...
  public partial class ConsequenceParams : IEquatable<ConsequenceParams>, IValidatableObject
  {
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ConsequenceParams" /> class.
    /// </summary>
    ...
    {
      return this.Equals(input as ConsequenceParams);
    }

    /// <summary>
    /// Returns true if ConsequenceParams instances are equal
    /// </summary>
    /// <param name="input">Instance of ConsequenceParams to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(ConsequenceParams input)
    {
      if (input == null)
      {
        return false;
