...
namespace Algolia.Search.Search.Models
{
  ...
  public partial class AttributeToUpdate : AbstractOpenAPISchema, IEquatable<AttributeToUpdate>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as AttributeToUpdate);
    }

    /// <summary>
    /// Returns true if AttributeToUpdate instances are equal
    /// </summary>
    /// <param name="input">Instance of AttributeToUpdate to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(AttributeToUpdate input)
    {
      if (input == null)
        return false;
