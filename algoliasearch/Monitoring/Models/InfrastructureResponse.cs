...
namespace Algolia.Search.Monitoring.Models
{
  ...
  public partial class InfrastructureResponse : IEquatable<InfrastructureResponse>, IValidatableObject
  {
    /// <summary>
    ...
    {
      return this.Equals(input as InfrastructureResponse);
    }

    /// <summary>
    /// Returns true if InfrastructureResponse instances are equal
    /// </summary>
    /// <param name="input">Instance of InfrastructureResponse to be compared</param>
    /// <returns>Boolean</returns>
    public bool Equals(InfrastructureResponse input)
    {
      if (input == null)
      {
        return false;
