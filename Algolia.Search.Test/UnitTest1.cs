...
namespace NUnit.Framework.Test
{
    ...
    public class AlgoliaClientTest
    {
        ...
        public void TestInitialize()
        {
            ...
            Environment.SetEnvironmentVariable("ALGOLIA_APPLICATION_ID", "YLGNV73XLW");
            Environment.SetEnvironmentVariable("ALGOLIA_API_KEY", "b20d7c433688cc377fdc12ca1ec96a12");
